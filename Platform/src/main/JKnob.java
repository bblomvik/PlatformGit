...
public class JKnob extends JComponent implements MouseListener, MouseMotionListener {
	...
	/**
	 * Get the current angular position of the knob in degrees 0 - 360
	 * 
	 * @return the current angle (degree) position of the knob
	 */
	...
	/**
	 * Here main is used simply as a test method. If this file is executed
	 * "java JKnob" then this main() method will be run. However, if another
	 * file uses a JKnob as a component and that file is run then this main is
	 * ignored.
	 */
